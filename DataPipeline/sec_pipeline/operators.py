...
# # ---------------------------------------------------------
# # Resolve project root and ensure /opt/airflow/src is importable
# # /opt/airflow/plugins/sec_pipeline/operators.py
# #   -> parents[3] == /opt/airflow
# # ---------------------------------------------------------
...
# # Import from your repo's src/ (mounted as /opt/airflow/src)
# from src.download_filings import main as download_main
# from src.extract_and_convert import ExtractItems, convert_json_to_parquet

# # Import constants from the sec_pipeline package (this package)
# # (Make sure plugins/sec_pipeline/__init__.py defines DATASET_DIR)
# try:
#     from . import DATASET_DIR               # preferred when loaded as a package
# except Exception:
#     # Fallback if plugin isn’t treated as a package for some reason
